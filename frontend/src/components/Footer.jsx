...
const Footer = ({ setCurrentPage }) => {
    ...
    return (
        <footer className="bg-[#113F67] text-white pt-8 pb-6 relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                    ...
                    <div>
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            <span className="text-xl font-bold text-white">MAHAPENA</span>
                        </div>
                        ...
                        <div className="flex space-x-4">
                            <a href="#" className="text-gray-300 hover:text-[#A1E3F9] transition-colors duration-300">
                            ...
                            {["Beranda", "Profil", "Proker", "Blog", "Merchandise"].map((item) => (
                                <li key={item}>
                                    <button
                                        ...
                                        className="text-gray-300 hover:text-white transition-colors duration-300 text-sm block w-full text-left"
                                    >
                                        {item}
                                    </button>
                                </li>
                ...
                <div className="border-t border-gray-600 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="flex space-x-6">
                            <button className="text-gray-300 hover:text-white text-sm transition-colors duration-300">
                                Kebijakan Privasi
                            </button>
                            <button className="text-gray-300 hover:text-white text-sm transition-colors duration-300">
                                Syarat & Ketentuan
            ...
            <div className="absolute top-1 left-0 w-full overflow-hidden transform -translate-y-1">
                <svg
                    ...
                    className="w-full h-12 text-[#0a2a44] fill-current"
                >
