...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#113F67] dark:bg-[#000000] h-[30rem] flex justify-center items-center text-white pt-8 pb-6 relative">
      ...
      {/* Dekorasi Wave */}
      <div className="absolute top-1 left-0 w-full overflow-hidden transform -translate-y-4">
        <svg
          viewBox="0 0 1440 320"
          preserveAspectRatio="none"
          className="w-full h-10 text-[#3674B5] dark:text-[#113F67] fill-current"
        >
          <path d="M0,224L80,202.7C160,181,320,139,480,149.3C640,160,800,224,960,229.3C1120,235,1280,181,1360,154.7L1440,128L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path>
        </svg>
      </div>
    </footer>
  );
